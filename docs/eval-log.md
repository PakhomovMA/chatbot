...
Вывод: на этом корпусе ветка ничего не меняет. Одного запроса хватает, чтобы обе части вопроса попали в
evidence даже при `top-k=3` — 25 чанков слишком мало, чтобы части конкурировали. Деградации нет ни на
