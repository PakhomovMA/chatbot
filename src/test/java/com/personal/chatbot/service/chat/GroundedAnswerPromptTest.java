...
class GroundedAnswerPromptTest {
    ...
    void rendersNumberedEvidenceHistoryAndQuestionFromTheTemplate() {
        ...
        assertThat(rendered).contains("Answer the user's question using ONLY the numbered evidence")
        ...
        assertThat(prompt.build("q", List.of(), hits)).doesNotContain(GroundedAnswerPrompt.HISTORY_HEADER);
    }
